    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository', models.ForeignKey(on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='modules', to='learn_python_server.courserepository')),
            ],
            options={
                'verbose_name': 'Module',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log', models.ForeignKey(default=None, null=True, on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='events', to='learn_python_server.logfile')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
                ('repository', models.ForeignKey(on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='timeline_events', to='learn_python_server.studentrepository')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LogEvent',
            fields=[
                ('timelineevent_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='learn_python_server.timelineevent')),
            ...
            bases=('learn_python_server.timelineevent',),
        ),
        migrations.CreateModel(
            name='SpecialTopic',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tool', django_enum.fields.EnumCharField(choices=[('delphi', 'tutor'), ('pytest', 'pytest'), ('docs', 'docs')], db_index=True, max_length=6)),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='assignments_added', to='learn_python_server.courserepositoryversion')),
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='learn_python_server.module')),
                ('removed', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assignments_removed', to='learn_python_server.courserepositoryversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('toolrun_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='learn_python_server.toolrun')),
                ('engagement_id', models.UUIDField(unique=True)),
            ...
            bases=('learn_python_server.toolrun',),
        ),
        migrations.CreateModel(
            name='TutorSession',
            fields=[
                ...
                ('engagement', models.ForeignKey(on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='sessions', to='learn_python_server.tutorengagement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backend_extra', models.JSONField(blank=True, null=True)),
                ('session', models.ForeignKey(on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='exchanges', to='learn_python_server.tutorsession')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.ForeignKey(on_delete=learn_python_server.models.NON_POLYMORPHIC_CASCADE, related_name='tests', to='learn_python_server.assignment')),
            ],
            options={
