    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timeline_events', to='learn_python_server.studentrepository')),
            ],
            options={
                'ordering': ('-timestamp',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tool', django_enum.fields.EnumCharField(choices=[('tutor', 'tutor'), ('pytest', 'pytest'), ('docs', 'docs')], db_index=True, max_length=6)),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.AddField(
            model_name='tutorengagement',
            name='log',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='engagement', to='learn_python_server.logfile'),
        ),
        migrations.CreateModel(
            name='TestEvent',
            fields=[
