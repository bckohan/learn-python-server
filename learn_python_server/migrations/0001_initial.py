# Generated by Django 4.2.5 on 2023-09-27 23:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logger', models.CharField(blank=True, default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner', django_enum.fields.EnumPositiveSmallIntegerField(choices=[(0, 'Student'), (1, 'Continuous Integration'), (2, 'Server')], db_index=True)),
                ('result', django_enum.fields.EnumPositiveSmallIntegerField(choices=[(0, 'Passed'), (1, 'Failed'), (2, 'Errored'), (3, 'Skipped')], db_index=True)),
                ('assignment', models.ManyToManyField(related_name='events', to='learn_python_server.assignment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enrollment', to='learn_python_server.studentrepository')),
