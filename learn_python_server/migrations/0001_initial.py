# Generated by Django 4.2.5 on 2023-09-26 00:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commit_count', models.PositiveIntegerField(db_index=True, default=0)),
                ('timestamp', models.DateTimeField(db_index=True, default=learn_python_server.models.datetime_now)),
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='learn_python_server.studentrepository')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log', models.FileField(blank=True, null=True, upload_to='tutor_logs')),
                ('backend', django_enum.fields.EnumCharField(choices=[('openai', 'Open Ai')], max_length=6)),
        ...
        migrations.AlterUniqueTogether(
            name='assignment',
            unique_together={('module', 'identifier'), ('module', 'name')},
        ),
    ]
